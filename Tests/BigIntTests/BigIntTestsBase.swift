...
public func +(lhs: Concatenating, rhs: Concatenating) -> Polynomial<BigInt> {
    return Polynomial(lhs).adding(other: Polynomial(rhs))
}
public func +(lhs: Concatenating, rhs: BigInt) -> Polynomial<BigInt> {
    return Polynomial(lhs).adding(constant: rhs)
}
public func +(lhs: BigInt, rhs: Concatenating) -> Polynomial<BigInt> {
...
public func ^^(lhs: Concatenating, rhs: Int) -> Polynomial<BigInt> {

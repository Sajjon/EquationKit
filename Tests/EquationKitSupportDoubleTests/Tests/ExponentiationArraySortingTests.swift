...
class ExponentiationArraySortingTests: DoubleTestsBase {
    ...
    static var allTests = [
        ...
        ("testSortingAlphabetically", testSortingAlphabetically),
        ("testSortingByExponent", testSortingByExponent),
        ("testSortingOfExponentiations", testSortingOfExponentiations),
    ]

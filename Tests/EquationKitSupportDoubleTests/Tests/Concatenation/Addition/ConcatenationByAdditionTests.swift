...
class ConcatenationByAdditionTests: DoubleTestsBase {
    ...
    static var allTests = [
        ("testNumberAddVariableAndReversed", testNumberAddVariableAndReversed),
        ("testNumberAddExponentiationAndReversed", testNumberAddExponentiationAndReversed),
        ("testNumberAddTermAndReversed", testNumberAddTermAndReversed),
        ("testNumberAddPolynomialAndReversed", testNumberAddPolynomialAndReversed),
        ("testVariableAddVariable", testVariableAddVariable),
        ("testVariableAddExponentiationAndReversed", testVariableAddExponentiationAndReversed),
        ("testVariableAddTermAndReversed", testVariableAddTermAndReversed),
        ("testVariableAddPolynomialAndReversed", testVariableAddPolynomialAndReversed),
        ("testExponentiationAddExponentiation", testExponentiationAddExponentiation),
        ("testExponentiationAddTermAndReversed", testExponentiationAddTermAndReversed),
        ("testExponentiationAddPolynomialAndReversed", testExponentiationAddPolynomialAndReversed),
        ("testTermAddTerm", testTermAddTerm),
        ("testTermAddPolynomialAndReversed", testTermAddPolynomialAndReversed),
        ("testPolynomialAddPolynomial", testPolynomialAddPolynomial),
        ("test3xAddY", test3xAddY),
    ]

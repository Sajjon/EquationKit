...
public protocol Algebraic: Atom, Evaluatable, Differentiatable, Substituationable, Hashable, CustomStringConvertible {
...
public extension PolynomialProtocol {
    ...
    init(_ atom: Atom) {
        ...
        } else if let variable = atom as? VariableStruct<NumberType> {
